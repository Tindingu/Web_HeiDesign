  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Taxonomy Management</p>
        <h2 className="text-2xl font-semibold text-slate-900">Quản lý category và style</h2>
      ...
      <StatsPanel
        ...
        summaries={[
          { label: "Category dự án", value: projectCategories.length, tone: "amber" },
          { label: "Style dự án", value: projectStyles.length, tone: "sky" },
          { label: "Category blog", value: blogCategories.length, tone: "emerald" },
