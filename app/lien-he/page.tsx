          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-base leading-8 text-slate-200">
                ...
                chuyên môn sẽ tư vấn định hướng phù hợp, phạm vi triển khai và
                ngân sách dự kiến theo từng giai đoạn thực hiện.
              </p>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-1">
              ...
              <article className="rounded-2xl border border-slate-200 bg-white p-4">
                ...
                <p className="mt-2 text-sm leading-7 text-slate-600">
                  Đội ngũ sẽ sắp xếp lịch khảo sát phù hợp và gửi đề xuất sơ bộ
                  sau buổi làm việc trực tiếp.
                </p>
              </article>
            </div>
          </aside>
